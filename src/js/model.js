...
export default {
  ...
  setPumps: action((state, pumps) => {
    state.pumps = [...pumps];
  }),

  calibrations: getSavedStorage("calibrations"),
  setCalibrations: action((state, calibrations) => {
    state.calibrations = [...calibrations];
  }),

  pumpsState: getSavedStorage("pumpsState"),
  setPumpsState: action((state, pumpsState) => {
    state.pumpsState = [...pumpsState];
  }),

  timeTolerance: getSavedStorage("timeTolerance"),
  setTimeTolerance: action((state, timeTolerance) => {
    state.timeTolerance = timeTolerance;
  }),
