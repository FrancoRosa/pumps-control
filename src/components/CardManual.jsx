...
const CardManual = ({ pump, recipe }) => {
  ...
  const [pulsesPerUnit, setPulsesPerUnit] = useState(
    calibrations[recipe.id].config[pump.id].pulses
  );
  const [fillTimeout, setFillTimeout] = useState(
    calibrations[recipe.id].config[pump.id].timeout
  );
    ...
    <div className="column">
      <div className="card">
        ...
        <div className="is-flex is-justify-content-space-around">
          <div>
            <p className="has-text-link heading has-text-centered mt-4 is-size-8">
              Time
            </p>
            <p className="title is-5 success has-text-centered">
              {seconds.toFixed(1)}
            </p>
          </div>
          <div>
        ...
        <div className="card-footer is-flex-direction-column">
          <p className="heading has-text-link has-text-centered mt-3 is-size-8">
            Results
          </p>
          <div className="is-flex is-justify-content-space-around mb-2">
            <div>
              ...
              <p className="title is-3 success has-text-centered">
                {fillTimeout}
              </p>
            </div>
            <div>
